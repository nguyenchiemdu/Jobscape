              ...
              child: Column(
                children: [
                  InkWell(
                    onTap: () {},
                    child: Container(
                      margin: EdgeInsets.symmetric(vertical: ScreenUtil().setWidth(8),horizontal: ScreenUtil().setHeight(8)),
                  ...
                  Container(
                    margin: EdgeInsets.only(bottom: ScreenUtil().setHeight(10),top:ScreenUtil().setHeight(12)),
                  ...
                  Container(
                      ...
                      child: TextField(
                          ...
                          decoration: InputDecoration(
                            hintText: 'Link to join/register workshop',
                            // contentPadding: EdgeInsets.only(
                            //     left: 14, top: 18, bottom: 18),
                            hintStyle: TextStyle(
                              fontFamily: 'SFProDisplay',
                  ...
                  Container(
                      ...
                      child: TextField(
                          ...
                          decoration: InputDecoration(
                            hintText: 'Organization Contact (Link)',
                            // contentPadding: EdgeInsets.only(
                            //     left: 14, top: 18, bottom: 18),
                            hintStyle: TextStyle(
                              fontFamily: 'SFProDisplay',
