...
class WorkshopCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return
      Stack(
        children: [Container(
            margin: EdgeInsets.only(right: ScreenUtil().setWidth(12),left: ScreenUtil().setWidth(2),bottom: ScreenUtil().setHeight(2)),
          ...
          Container(
              ...
              child: Center(
                ...
                child: Image.asset("assets/images/info_icon.png",width: ScreenUtil().setWidth(20),height: ScreenUtil().setHeight(20)),
              )
          ),
          Container(
              margin: EdgeInsets.only(left: ScreenUtil().setWidth(156),top:ScreenUtil().setHeight(173)),
              width: ScreenUtil().setWidth(38),
              height: ScreenUtil().setHeight(38),
              decoration: new BoxDecoration(
                color: Color(0xffffbf2f),
              ...
              child: Center(
                ...
                child: Image.asset("assets/images/register_icon.png",width: ScreenUtil().setWidth(17),height: ScreenUtil().setHeight(17)),
              )
          ),
        ]
      );
