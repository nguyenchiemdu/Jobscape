          ...
          Container(
            ...
            child: Row(
              ...
              children: <Widget>[
                  ...
                  Expanded(
                    child: Text("File format: Image or Document (.img, .png, .pdf)",
                            style: TextStyle(
                            fontFamily: 'SFProDisplay',
          ...
          Row(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: Expanded(
                  child: Text("After your proof gets validated by admin, your next skill(s) will be unlocked.",
                      style: TextStyle(
                        fontFamily: 'SFProDisplay',
                        color: Color(0xff454545),
                        fontSize: ScreenUtil().setSp(14),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text("(Drag and drop files here, or browse your phone)",
                              style: TextStyle(
                                fontFamily: 'SFProDisplay',
                                color: Color(0xff888888),
