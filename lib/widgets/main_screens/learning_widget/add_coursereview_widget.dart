...
class AddReviewFormWidget extends StatelessWidget {
  ...
  void submitReview(){
    ...
    Map<String,dynamic> reviews = {"user": 'Nguyen Hai Phong' ,"reviewText":"Default","upvote":0,"star":0,"time":DateTime.now()};
    reviews['reviewText'] = 'This course is very wonderful for newbies like me. Very well explain, the professor are so helpful. Thank you Jobscape';
