...
class SkillItem extends StatelessWidget {
  final Map skillItem;
  final String imgSrc;
  SkillItem(this.skillItem, this.imgSrc);
            ...
            children: [
                ...
                child: Container(
                  ...
                  decoration: new BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: NetworkImage(
                          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRw7L7A7_u4dd2X675qYCf-vIS0-OJzC64uHQ&usqp=CAU"),
                      fit: BoxFit.fill,
              ...
              Container(
               ...
               Column(
                    ...
                    children: [
                      Container(
                        margin: EdgeInsets.only(left: ScreenUtil().setWidth(10),bottom: ScreenUtil().setHeight(5)),
                        width: ScreenUtil().setWidth(131),
                        child:
                        Text( cateFind(skillItem['category'])
                       ...
                       Container(
                          ...
                          width: ScreenUtil().setWidth(131),
                          height: skillItem['name'].length <= 17 ? ScreenUtil().setHeight(57) : ScreenUtil().setWidth(48),
                          child:
                          Text( stringFind(skillItem['category']),
