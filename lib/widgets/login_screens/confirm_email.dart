        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text("Please click on the link that has been sent to your email account to verify your email. If you don't see it, you may need to check your spam folder.",
                  style: TextStyle(
                    fontFamily: 'SFProDisplay',
                    color: Color(0xff303030),
                    fontSize: 16,
